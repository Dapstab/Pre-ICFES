...
export const QuestionForm = () => {
    ...
    function sendQuestionData() {
        questionForm.addEventListener('submit', (e) => {
            ...
            let opciones = [];
            document.querySelectorAll('.options').forEach( el => opciones.push(el.value));
            let respuesta;
            ...
            Question.createQuestion(pregunta, opciones, respuesta, asignatura, temas, subtemas, dificultad);
        });  
    }
}